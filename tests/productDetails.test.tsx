...
import ProductDetails from '../pages/products/[productId]/details';
...
describe('<ProductDetails />', () => {
  ...
  test('it should show product details correctly', async () => {
    ...
    expect(img[1]).toHaveAttribute('src', '/_next/image?url=https%3A%2F%2Fd1ccwz5tu7strp.cloudfront.net%2Fundefined%2Fmain.jpg&w=1920&q=75')
